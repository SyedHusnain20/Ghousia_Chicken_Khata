...
const khataApi: KhataApi = {
  ...
  listPartiesWithActivity: (req) => ipcRenderer.invoke(IpcChannels.PARTY_LIST_WITH_ACTIVITY, req),
  deleteParty: (req) => ipcRenderer.invoke(IpcChannels.PARTY_DELETE, req),
  forceDeleteParty: (req) => ipcRenderer.invoke(IpcChannels.PARTY_FORCE_DELETE, req),
  addEntry: (req) => ipcRenderer.invoke(IpcChannels.ENTRY_ADD, req),
  updateEntry: (req) => ipcRenderer.invoke(IpcChannels.ENTRY_UPDATE, req),
  deleteEntry: (req) => ipcRenderer.invoke(IpcChannels.ENTRY_DELETE, req),
  ...
  listUnbilledPayments: (req) => ipcRenderer.invoke(IpcChannels.PAYMENT_LIST_UNBILLED, req),
  ...
  saveDailyLedgerUdhars: (req) => ipcRenderer.invoke(IpcChannels.DAILY_LEDGER_SAVE_UDHARS, req),
